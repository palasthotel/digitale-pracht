...
if ( ! function_exists( 'digitalepracht_image_sizes' ) ) :
	function digitalepracht_image_sizes() {
		$image_sizes = array(
			'teaser-big-desktop-2x' => array(
				'width'  => 786,
				'height' => 786,
				'crop'   => true,
			),
			'teaser-illustrated-desktop-2x' => array(
				'width'  => 224,
				'height' => 224,
				'crop'   => true,
			),
			'teaser-illustrated-mobile-max-2x' => array(
				'width'  => 432,
				'height' => 432,
				'crop'   => true,
			),
			'teaser-illustrated-mobile-min-2x' => array(
				'width'  => 144,
				'height' => 144,
				'crop'   => true,
			),
...
if ( ! function_exists( 'digitalepracht_image_definition' ) ) :
	function digitalepracht_image_definition() {
		...
		set_post_thumbnail_size(
			$image_sizes[ 'teaser-big-desktop-2x' ][ 'width' ],
			$image_sizes[ 'teaser-big-desktop-2x' ][ 'height' ],
			$image_sizes[ 'teaser-big-desktop-2x' ][ 'crop' ]
		);
	}
endif;
