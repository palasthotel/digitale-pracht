...
<div class="grid-container has-title">
	<div class="grid-container-before">
		<h1 class="grid-container-title"><?php esc_html_e( 'No content found', 'digitale-pracht' ); ?></h1>
	</div>
	<div class="grid-slots-wrapper">
		<div class="grid-slot grid-slot-1d1">
			<div class="grid-box is-indented grid-box-404">

				<h2 class="h404"><?php esc_html_e( 'Oops, nothing to show here.', 'digitale-pracht' ); ?></h2>
